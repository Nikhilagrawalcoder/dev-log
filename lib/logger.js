...
class Logger {
  ...
  log(level, message) {
    ...
    // Ensure that the color is valid by checking if it's a function in chalk
    const coloredMessage = typeof chalk[color] === 'function' ? chalk[color](formattedMessage) : chalk.white(formattedMessage);
